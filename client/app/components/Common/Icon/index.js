...
const ModernCartIcon = ({ className = '', width = '24', height = '24' }) => (
  <svg
    className={`${className} modern-cart-icon`}
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
const SearchIcon = ({ className = '', width = '20', height = '20', color = 'currentColor' }) => (
  <svg
...
const TruckIcon = ({ className = '', width = '24', height = '24', color = 'currentColor' }) => (
  <svg
    className={`${className} truck-icon`}
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
const ShieldCheckIcon = ({ className = '', width = '24', height = '24', color = 'currentColor' }) => (
  <svg
    className={`${className} shield-icon`}
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
const PhoneCallIcon = ({ className = '', width = '24', height = '24', color = 'currentColor' }) => (
  <svg
...
const GiftIcon = ({ className = '', width = '24', height = '24', color = 'currentColor' }) => (
  <svg
    className={`${className} gift-icon`}
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
const FireIcon = ({ className = '', width = '20', height = '20', color = '#ff5722' }) => (
  <svg
    className={`${className} fire-icon`}
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
    viewBox="0 0 24 24"
    ...
    stroke="none"
  >
    <path d="M12 23c-4.97 0-9-4.03-9-9 0-3.3 1.83-6.22 4.67-7.75.52-.28 1.18-.04 1.41.48.21.48.06 1.05-.35 1.37C7.45 9.07 7 10.48 7 12c0 2.76 2.24 5 5 5s5-2.24 5-5c0-1.89-.95-3.64-2.52-4.66-.46-.3-.62-.89-.39-1.39.23-.5.84-.77 1.36-.54C18.66 6.88 21 10.23 21 14c0 4.97-4.03 9-9 9zM12 3c-.55 0-1 .45-1 1 0 2.21-1.79 4-4 4-.55 0-1 .45-1 1s.45 1 1 1c3.31 0 6-2.69 6-6 0-.55-.45-1-1-1z" />
  </svg>
);

const StoreLogoIcon = ({ className = '', width = '34', height = '34' }) => (
  <svg
    className={`${className} store-logo-icon`}
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
    viewBox="0 0 48 48"
  ...
  >
    ...
    <path
      d="M24 12L12 19L24 26L36 19L24 12Z"
      stroke="#ffffff"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const PlusIcon = ({ className = '', width = '18', height = '18', color = 'currentColor' }) => (
  <svg
